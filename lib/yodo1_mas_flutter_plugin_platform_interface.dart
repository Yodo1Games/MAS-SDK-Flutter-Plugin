...
abstract class Yodo1MasFlutterPluginPlatform extends PlatformInterface {
  ...
  static Yodo1MasFlutterPluginPlatform _instance =
      MethodChannelYodo1MasFlutterPlugin();
  ...
  Future<void> initSdk(
    ...
    throw UnimplementedError(
        'initSdk(str, bool, bool, bool, bool) has not been implemented.');
  }
  ...
  void setInitListener(Function(bool successful)? callback) {
    throw UnimplementedError(
        'setInitListener(Function(bool)?) has not been implemented.');
  }

  void setRewardListener(Function(int event, String message)? callback) {
    throw UnimplementedError(
        'setRewardListener(Function(int, String)?) has not been implemented.');
  }

  void setInterstitialListener(Function(int event, String message)? callback) {
    throw UnimplementedError(
        'setInterstitialListener(Function(int, String)?) has not been implemented.');
  }

  void setAppOpenListener(Function(int event, String message)? callback) {
    throw UnimplementedError(
        'setAppOpenListener(Function(int, String)?) has not been implemented.');
  }

  void setBannerListener(Function(int event, String message)? callback) {
    throw UnimplementedError(
        'setBannerListener(Function(int, String)?) has not been implemented.');
  }
